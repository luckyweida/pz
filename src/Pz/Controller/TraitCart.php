...
//                $template = 'payment-failed.twig';
    ...
    static function getPaypalParams($orderContainer)
    {
        ...
        $cardInput = array(
            ...
            'billingPhone' => $dialCode ? $dialCode . ltrim($orderContainer->getBillingPhone(), '0') : $orderContainer->getBillingPhone(),
            'billingCity' => $orderContainer->getBillingCity(),
            'billingState' => '',
            'billingPostCode' => $orderContainer->getBillingPostcode(),
            'billingCountry' => strtolower($orderContainer->getBillingCountry()),
            'email' => $orderContainer->getEmail(),
        );
//        var_dump($cardInput);exit;
